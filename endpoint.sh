...
# ARG_HELP([Generates an X.509 cert pair for the specified endpoint and loads it into your YubiKey.])
# ARGBASH_GO()
...
print_help() {
	printf '%s\n' "Generates an X.509 cert pair for the specified endpoint and loads it into your YubiKey."
