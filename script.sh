...
x509 -engine pkcs11 -CAkeyform engine -sha512 -CAkey slot_0-id_2 -CA slot_9c-crt.pem -req -passin pass:$pin -in $host/csr.pem -extfile $host/crt.conf -days $(( ( RANDOM % 1000 )  + 365*50 )) -out $host/crt.pem
EOF
